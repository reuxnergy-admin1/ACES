        ...
        <ContainerRow>
          {status === 'success' ? (
            <div className="text-center py-12">
              <h2 className="text-2xl font-light mb-4">Thank you for your enquiry!</h2>
            ...
            <form onSubmit={handleSubmit} method="POST" className="w-full">
              ...
              <Grid12 data-reveal-blur-stagger>
                ...
                <Span cols={6}>
                  <label htmlFor="company" className="block text-white/60 text-sm mb-2">Company *</label>
                  <input 
                    id="company" 
                    name="company" 
                    required 
                ...
                <Span cols={12}>
                  <label htmlFor="details" className="block text-white/60 text-sm mb-2">Project details *</label>
                  <textarea 
                    id="details" 
                    name="details" 
                    required 
                ...
                <Span cols={8}>
                  ...
                  >
                    ...
                    <span className="sr-only">{status === 'submitting' ? 'Sending...' : 'Send Quote Request'}</span>
                    <span aria-hidden="true">{status === 'submitting' ? 'Sending...' : 'Send Quote Request'}</span>
                  </button>
                </Span>
              </Grid12>
            </form>
