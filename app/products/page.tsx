...
export const metadata: Metadata = {
  ...
  description:
    "Aircraft transparencies, helicopter windows, motorsport components, and aerospace composite parts. SACAA-approved manufacturing in Potchefstroom, South Africa for local and global aviation.",
};
