...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Design for manufacturability, CNC tooling, thermoforming, edge finishing, coatings, and quality assurance for aircraft transparencies and composite components.",
};
