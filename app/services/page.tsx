...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Design for manufacturability, CNC tooling, thermoforming, edge finishing, coatings, and quality assurance for aircraft transparencies and composites. South Africa-based SACAA-approved facility.",
};
  ...
  return (
    <section className="grid-shell section-band pt-[140px] sm:pt-[150px] lg:pt-[160px]">
      ...
      <ContainerRow className="mt-6">
        <Grid12 data-reveal-blur-stagger>
          <Span cols={6}>
            <div className="body list-disc list-inside text-white/70">
          ...
          <Span cols={6}>
            <div className="body list-disc list-inside text-white/70">
              <li>
                Coatings (scratch-resistant / anti-fog via approved processes)
              </li>
            </div>
          </Span>
          <Span cols={6}>
