      ...
      <SectionBand>
        <ContainerWide>
          <Grid12 className="gutter" data-reveal-stagger>
            <Span cols={8}>
              <h1 className="text-5xl md:text-6xl font-semibold max-w-full">Insights</h1>
            </Span>
            <Span cols={4}>
              <p>Latest writing on aero simulations, composites, and manufacturing.</p>
            </Span>
          </Grid12>
        </ContainerWide>
      </SectionBand>
      <SectionBand>
        <ContainerRow>
          <div className="auto-grid" data-reveal-stagger>
            {['Reading the wind', 'CFD pitfalls', 'Tunnel correlation'].map((t) => (
