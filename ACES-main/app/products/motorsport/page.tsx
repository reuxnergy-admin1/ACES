...
export const metadata: Metadata = {
  title: "Motorsport Composites",
  description:
    "High-performance composite components and aerodynamic parts for motorsport. Precision engineering from South Africa by ACES Aerodynamics.",
};
        ...
        <Grid12 data-reveal-blur-stagger>
          ...
          <Span cols={8}>
            <p className="mt-6 body text-white/70 max-w-reading">
              Placeholder catalogue and engineering notes for motorsport. Supply
