...
export default function InViewReveals() {
  ...
  useEffect(() => {
    ...
    if (typeof (window as Window & { IntersectionObserver?: typeof IntersectionObserver }).IntersectionObserver === 'undefined') {
    ...
    try { (document as Document & { fonts?: { ready?: Promise<void> } }).fonts?.ready?.then(rescan); } catch { /* noop */ }
