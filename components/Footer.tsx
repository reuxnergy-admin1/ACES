...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-6 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-lg shadow-xl whitespace-nowrap z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">LinkedIn</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-6 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-lg shadow-xl whitespace-nowrap z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">Facebook</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-6 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-lg shadow-xl whitespace-nowrap z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">Instagram</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-6 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-lg shadow-xl whitespace-nowrap z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">WhatsApp</span>
            </a>
          </div>
          </Span>
          <Span cols={12}>
