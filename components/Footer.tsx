        ...
        <div className="container-wide py-16 grid-12 gutter text-sm text-white/70">
          ...
          <div className="mt-3 flex items-center gap-3">
            <a className="group relative inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 transition-colors" href="https://www.linkedin.com/company/aces-aerodynamics" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              ...
              <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 text-xs text-white bg-white/10 backdrop-blur-md border border-white/20 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">LinkedIn</span>
            </a>
            <a className="group relative inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 transition-colors" href="https://www.facebook.com/acesaerodynamics" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              ...
              <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 text-xs text-white bg-white/10 backdrop-blur-md border border-white/20 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">Facebook</span>
            </a>
            <a className="group relative inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 transition-colors" href="https://www.instagram.com/acesaerodynamics" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 text-xs text-white bg-white/10 backdrop-blur-md border border-white/20 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">Instagram</span>
            </a>
            <a className="group relative inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 transition-colors" href="https://wa.me/27828935583" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
              ...
              <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 text-xs text-white bg-white/10 backdrop-blur-md border border-white/20 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">WhatsApp</span>
            </a>
          </div>
          </Span>
          <Span cols={12}>
