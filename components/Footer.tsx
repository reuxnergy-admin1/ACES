...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-auto min-w-max px-4 py-2 text-sm text-white text-center bg-white/20 backdrop-blur-md border border-white/40 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">LinkedIn</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-auto min-w-max px-4 py-2 text-sm text-white text-center bg-white/20 backdrop-blur-md border border-white/40 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">Facebook</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-auto min-w-max px-4 py-2 text-sm text-white text-center bg-white/20 backdrop-blur-md border border-white/40 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">Instagram</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-auto min-w-max px-4 py-2 text-sm text-white text-center bg-white/20 backdrop-blur-md border border-white/40 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">WhatsApp</span>
            </a>
          </div>
          </Span>
          <Span cols={12}>
