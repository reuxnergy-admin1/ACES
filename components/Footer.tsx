...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-black/90 text-white text-sm font-medium px-6 py-2 rounded-lg whitespace-nowrap w-auto shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">LinkedIn</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-black/90 text-white text-sm font-medium px-6 py-2 rounded-lg whitespace-nowrap w-auto shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">Facebook</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-black/90 text-white text-sm font-medium px-6 py-2 rounded-lg whitespace-nowrap w-auto shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">Instagram</span>
            </a>
...
<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-black/90 text-white text-sm font-medium px-6 py-2 rounded-lg whitespace-nowrap w-auto shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">WhatsApp</span>
            </a>
          </div>
          </Span>
          <Span cols={12}>
