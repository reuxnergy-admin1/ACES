...
export default function Listbox({
  ...
  useEffect(() => {
    ...
    setPlaceAbove(
      spaceBelow < Math.min(maxHeight, 320) && spaceAbove > spaceBelow,
    );
  }, [open, maxHeight]);
  ...
  return (
    <div className={clsx("ui-lb relative inline-block w-full", className)}>
      ...
      >
        ...
        <span
          aria-hidden
          className="ui-lb__icon absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-white/70"
        >
          <svg
            width="14"
            height="14"
