...
export function middleware(req: NextRequest) {
  ...
  res.headers.set('Permissions-Policy', 'geolocation=(), microphone=(), camera=()');
  // Performance: hint browser to preconnect to font CDN
  res.headers.set('Link', '<https://use.typekit.net>; rel=preconnect; crossorigin, <https://fonts.gstatic.com>; rel=preconnect; crossorigin');
